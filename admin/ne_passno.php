...
echo "<h1>Administrace &gt; Neschválené novinky</h1>\n";
...
$vysledek = mysqli_query($db,"select n.*, a.jmeno from novinky n, autori a where n.autor = a.id and stav = 'n' order by n.id desc limit $zaznam, $pocet");
