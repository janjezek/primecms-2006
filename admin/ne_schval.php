...
echo "<h1>Administrace &gt; Schválit novinky</h1>\n";
...
$vysledek_celk = mysqli_query($db,"select id from novinky where stav = 'n'");
$vysledek = mysqli_query($db,"select n.*, a.jmeno from novinky n, autori a where n.autor = a.id and stav = 'n'order by n.datum desc limit $zaznam, $pocet");
